    ...
    <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <FormField htmlFor="inspection-page-size" label="Rows per page">
            <select
          ...
          <FormField htmlFor="inspection-page-jump" label="Jump to page">
            <input
              className="block w-full rounded-md border border-slate-300 px-3 py-2 text-slate-950 shadow-sm outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-100 disabled:bg-slate-100"
              disabled={isDisabled}
              id="inspection-page-jump"
              max={totalPages}
              min={1}
              onChange={(event) => {
