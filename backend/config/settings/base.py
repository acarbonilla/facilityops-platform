...
# FO-091: AI Knowledge Base rule-based similarity weights (points → 0–100).
FACILITYOPS_AI_SIMILAR_WEIGHT_CATEGORY = config_int(
    "FACILITYOPS_AI_SIMILAR_WEIGHT_CATEGORY",
    default=25,
)
FACILITYOPS_AI_SIMILAR_WEIGHT_KEYWORDS = config_int(
    "FACILITYOPS_AI_SIMILAR_WEIGHT_KEYWORDS",
    default=20,
)
FACILITYOPS_AI_SIMILAR_WEIGHT_LOCATION = config_int(
    "FACILITYOPS_AI_SIMILAR_WEIGHT_LOCATION",
    default=15,
)
FACILITYOPS_AI_SIMILAR_WEIGHT_ASSET = config_int(
    "FACILITYOPS_AI_SIMILAR_WEIGHT_ASSET",
    default=15,
)
FACILITYOPS_AI_SIMILAR_WEIGHT_RECOMMENDATION = config_int(
    "FACILITYOPS_AI_SIMILAR_WEIGHT_RECOMMENDATION",
    default=10,
)
FACILITYOPS_AI_SIMILAR_WEIGHT_FINDINGS = config_int(
    "FACILITYOPS_AI_SIMILAR_WEIGHT_FINDINGS",
    default=10,
)
FACILITYOPS_AI_SIMILAR_WEIGHT_PRIORITY = config_int(
    "FACILITYOPS_AI_SIMILAR_WEIGHT_PRIORITY",
    default=5,
)
