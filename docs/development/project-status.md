...
- Project Management — **FO-105 Gantt & dependencies COMPLETE** on shared `feature/project-management` (unmerged; FO-106 not started)
- UX-001 COMPLETE AND MERGED; AI Platform v1.0 FROZEN
- FO-102 Gemini billing/quota diagnostics — **DEFERRED**

## Current Branch

- Active: `feature/project-management` (FO-105 checkpoint; unmerged; Draft PR #67)
...
- FO-105 — Gantt Chart & Task Dependencies **COMPLETE** on `feature/project-management` (unmerged).
  See `docs/02-Development/FO-105 - Gantt Chart and Task Dependencies.md`.
- FO-103 foundation and FO-104 tasks remain complete on the same branch.
...
- FO-106 — Timeline, Notes & Issues on shared `feature/project-management`
