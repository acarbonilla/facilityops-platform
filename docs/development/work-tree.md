...
| Project Management | FO-108 COMPLETE on feature branch (unmerged) | PM-UX-001/001A on `main`; FO-103–FO-108 on `feature/project-management`; FO-109/FO-109A next; Draft PR #67; FO-102 deferred |
