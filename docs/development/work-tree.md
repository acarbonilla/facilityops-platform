...
| Attachments | FO-081 implemented on shared branch | FO-079/FO-080 merged; FO-081 FM Ticket integration on `feature/business-module-attachments`; FO-082/FO-083 not started; grouped merge pending |
...
- FO-081 FM Ticket Attachment Integration is **implemented** on shared branch
  `feature/business-module-attachments` (unmerged). FO-082 / FO-083 have not
  started. Do not merge FO-081 independently.
