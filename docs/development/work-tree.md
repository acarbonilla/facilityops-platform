...
| FM Ticketing | FO-094 Ready for Review | FO-094 PR #60 Ready for Review; FO-093 on `main`; FO-095 **not started** |
...
| Reporting and Operational Analytics | Complete + FO-094 Ready for Review | FO-064–FO-093 on main; FO-094 PR #60 under `settings.manage`; FO-095 **not started** |
