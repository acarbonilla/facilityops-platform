...
| Notifications | Complete | FO-055 backend notification model, migration, recipient-scoped read APIs, creation service foundation, admin registration, and focused tests |
...
- FO-055 completes Notifications backend foundation with UUID notification persistence, tenant/recipient consistency enforcement, transactional creation service, recipient-scoped list/detail/unread-count APIs, admin registration, and focused backend validation.
