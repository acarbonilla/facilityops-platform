...
| FM Ticketing | AI Platform MVP COMPLETE (RM-001); UX-001 Ready for Review | AI Platform v1.0 freeze `98c1661…`; main tip `60696d1…`; UX-001/UX-001A on PR #62; FO-096 **not started** |
...
| Intelligent Employee Intake (design) | UX-001 / UX-001A Ready for Review | Design + finalization docs in `docs/03-UX/`; PR #62; FO-096–FO-101 planned only; FO-096 **not started** |
