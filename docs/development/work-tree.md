...
| FM Ticketing | FO-093 Ready for Review | FO-093 PR #59 Ready for Review; FO-092 on `main`; FO-094 **not started** |
...
| Reporting and Operational Analytics | Complete + FO-093 Ready for Review | FO-064–FO-092 on main; FO-093 PR #59 under `settings.manage`; FO-094 **not started** |
