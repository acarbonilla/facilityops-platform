...
| Project Management | COMPLETE AND MERGED + FO-115 Gantt refinement | FO-103–FO-114A on `main`; FO-115 on `feature/interactive-gantt-tenant-scope` (unmerged); FO-102 deferred; FO-115A NOT STARTED |
