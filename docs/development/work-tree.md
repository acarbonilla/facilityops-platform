...
| FM Ticketing | FO-097 AI-first submit on feature branch | Shared `feature/intelligent-employee-intake`; FO-096+FO-097 complete unmerged; FO-098 **not started**; AI Platform v1.0 freeze `98c1661…` |
...
| Intelligent Employee Intake | FO-097 complete (unmerged) | Branch `feature/intelligent-employee-intake`; FO-098–FO-101 remaining; no standalone FO-097 PR |
