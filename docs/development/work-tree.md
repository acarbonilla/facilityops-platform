...
| FM Ticketing | AI Platform MVP COMPLETE (RM-001); UX-001 design Draft | AI Platform v1.0 freeze `98c1661…`; main tip `60696d1…`; UX-001 docs on `docs/ux-001-intelligent-employee-intake`; FO-096 **not started** |
...
| Intelligent Employee Intake (design) | UX-001 Draft PR | Design blueprint in `docs/03-UX/UX-001 - Intelligent Employee Ticket Intake Design.md`; implementation FO-096–FO-101 planned only |
