...
| FM Ticketing | FO-092 Draft PR | FO-092 on `feature/fo-092-executive-ai-dashboard`; FO-091 on `main` via PR #57 (`f1e6168…`); FO-093 **not started** |
...
| Reporting and Operational Analytics | Complete + FO-092 Draft PR | FO-064–FO-091 on main; FO-092 Executive AI Dashboard Draft PR under `reporting.view`; FO-093 **not started** |
