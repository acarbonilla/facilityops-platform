...
| FM Ticketing | FO-096 intake foundation on feature branch | Shared `feature/intelligent-employee-intake`; FO-096 complete unmerged; FO-097 **not started**; AI Platform v1.0 freeze `98c1661…` |
...
| Intelligent Employee Intake | FO-096 complete (unmerged) | Branch `feature/intelligent-employee-intake`; FO-097–FO-101 remaining; no standalone FO-096 PR |
