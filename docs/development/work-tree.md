...
| FM Ticketing | FO-092 COMPLETE AND MERGED | FO-092 on `main` via PR #58; FO-093 AI Admin Draft PR; FO-094 **not started** |
...
| Reporting and Operational Analytics | Complete + FO-093 Draft PR | FO-064–FO-092 on main; FO-093 AI Administration Draft PR (`settings.manage`); FO-094 **not started** |
