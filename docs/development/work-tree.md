...
| Notifications | In Progress | FO-055 through FO-057A are complete; FO-058A adds FM Ticket assignment and status-change notifications; FO-058B adds Maintenance assignment, reassignment, and workflow notifications; FO-058C adds 5S Inspection assignment and status-change notifications; FO-059 and FO-060 remain pending |
...
- Notifications is currently `In Progress`: FO-055 through FO-057A are complete, FO-058A adds FM Ticket assignment and status-change notifications, FO-058B adds Maintenance assignment, reassignment, and workflow notifications, FO-058C adds 5S Inspection assignment and status-change notifications, and FO-059 and FO-060 remain pending.
