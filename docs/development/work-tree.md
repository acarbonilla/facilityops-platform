...
| FM Ticketing | FO-091 COMPLETE AND MERGED | FO-091 on `main` via PR #57 (`f1e6168…`); FO-090 via PR #56; FO-092 ready (**not started**) |
...
| Reporting and Operational Analytics | Complete + FO-091 knowledge base on main | FO-064–FO-091 on main under `reporting.view`; FO-092 ready (**not started**) |
