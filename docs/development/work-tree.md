...
| Reporting and Operational Analytics | In Progress | FO-064 through FO-066A complete on `feature/reporting` (draft PR #38); Work Order drill-down dates are reconciled to `requested_at`; manual acceptance / final QA, export, and charts deferred |
