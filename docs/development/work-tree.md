...
| FM Ticketing | FO-094 Draft PR | FO-094 AI Monitoring Draft PR; FO-093 on `main`; FO-095 **not started** |
...
| Reporting and Operational Analytics | Complete + FO-094 Draft PR | FO-064–FO-093 on main; FO-094 monitoring Draft PR (`settings.manage`); FO-095 **not started** |
