...
| Project Management | COMPLETE AND MERGED through FO-116A; FO-117 in progress | FO-103–FO-116A on `main`; FO-117 Planned Schedule Task list display on `feature/project-task-schedule-display` (Draft PR; FO-117A not started); FO-102 deferred |
