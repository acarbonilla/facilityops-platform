...
| Project Management | COMPLETE AND MERGED through FO-115A | FO-103–FO-115A on `main` (PR #69); FO-116 shell/validation UX on `feature/application-shell-validation-ux`; FO-102 deferred |
