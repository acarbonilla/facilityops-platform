...
| FM Ticketing | FO-090 attention center finalizing | FO-089 on `main` via PR #55 (`19fea43…`); FO-090 PR #56 reconciling (FO-090A); FO-091 not started |
...
| Reporting and Operational Analytics | Complete + FO-089 on main; FO-090 finalizing | FO-064–FO-089 on main; FO-090 attention center PR #56 reconciling under `reporting.view` |
