...
| FM Ticketing | FO-099 smart notifications on feature branch | Shared `feature/intelligent-employee-intake`; FO-096–FO-099 complete unmerged; FO-100 **not started**; AI Platform v1.0 freeze `98c1661…` |
...
| Reporting and Operational Analytics | Complete + AI Platform MVP v1.0 | FO-064–FO-095 on main; RM-001 freeze; FO-100 planned for intake reporting alignment |
| Intelligent Employee Intake | FO-099 complete (unmerged) | Branch `feature/intelligent-employee-intake`; FO-100–FO-101 remaining; no standalone FO-099 PR |
...
- FO-075 adds the Employee system role with only `fm_tickets.view` and
  ...
  and any need for `settings.view`.
- FO-076 delivers the Employee My Requests frontend experience (routes,
  navigation, list/create/detail, operational redirects).
- FO-077 / FO-077A deliver requester cancel/acknowledge/reopen workflows with
  concurrency locking, accessible confirmation dialogs, and Employee
  notification targets at `/my-requests/{id}`.
- FO-078 cumulative QA found no requester production defects; FO-078A corrected
...
- FO-079 Secure Attachment Backend and Storage Foundation is **complete and
  merged** via PR #45 at `43bbb8d6eb858fb7043deb3dc600f8c0ab0deace`. Manual
  acceptance Passed 2026-07-27 (26/26). Feature branch removed after
  verification.
- FO-080 Attachment Upload UI is **complete and merged** via PR #46 at
  `76c234c80c4fe7dd80ccb5a05910155bba631e22`. Manual acceptance Passed
  2026-07-27 (36/36). Feature branch removed after verification.
- FO-081 FM Ticket Attachment Integration is **complete** on shared branch
  `feature/business-module-attachments`.
- FO-082 Maintenance and 5S Attachment Integration is **complete** on the
  same shared branch.
