...
| Attachments | FO-080 in progress | FO-079 backend merged via PR #45; FO-080 Attachment Upload UI on `feature/attachment-upload-ui`; FO-081+ module embedding not started |
...
- FO-079 Secure Attachment Backend and Storage Foundation is **complete and
  ...
  verification.
- FO-080 Attachment Upload UI is implemented on `feature/attachment-upload-ui`
  (shared uploader/list, `/attachments` workspace, React Query + FO-079 APIs).
  FO-081 / FO-082 / FO-083 and AI have not started.
