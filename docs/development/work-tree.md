...
| FM Ticketing | FO-095 Draft PR | FO-095 AI Platform QA Draft PR; FO-094 on `main`; FO-096 **not started** |
...
| Reporting and Operational Analytics | Complete + FO-095 Draft PR | FO-064–FO-094 on main; FO-095 platform QA Draft PR; FO-096 **not started** |
