...
| Notifications | In Progress | FO-055 through FO-057A are complete; FO-058A through FO-058C add business-module notifications; FO-058CA corrects inspection assignment deduplication; FO-059 adds preference persistence, preference API/UI, and in-app delivery tracking; FO-060 remains pending |
...
- Notifications is currently `In Progress`: FO-055 through FO-057A are complete, FO-058A through FO-058C add business-module notifications, FO-058CA corrects inspection assignment deduplication, FO-059 adds preference persistence/API/UI and in-app delivery tracking, and FO-060 remains pending.
