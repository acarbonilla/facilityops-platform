...
| Attachments | FO-079 complete; merged | Secure attachment backend/storage foundation merged via PR #45 (`43bbb8d…`); FO-080+ not started |
...
- FO-079 Secure Attachment Backend and Storage Foundation is **complete and
  ...
  verification. FO-080+ and AI have not started.
