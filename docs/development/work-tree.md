...
| Notifications | In Progress | FO-055 backend notification model, migration, recipient-scoped read APIs, creation service foundation, admin registration, and focused tests are complete; FO-056 through FO-060 remain pending |
...
- Notifications is currently `In Progress`: FO-055 backend foundation is complete, while FO-056 through FO-060 remain pending.
