...
| FM Ticketing | FO-090 COMPLETE AND MERGED | FO-090 on `main` via PR #56 (`93bb534…`); FO-089 via PR #55; FO-091 ready (**not started**) |
...
| Reporting and Operational Analytics | Complete + FO-090 attention center on main | FO-064–FO-090 on main under `reporting.view`; FO-091 ready (**not started**) |
