...
| Reporting and Operational Analytics | In Progress | FO-064 + FO-064A complete on `feature/reporting` (draft PR #38); overview filters limited to date/building/organization with UUID and access validation; frontend (FO-065), status/priority UX (FO-066), export, and charts deferred |
