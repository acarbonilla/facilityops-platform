...
| Project Management | COMPLETE AND MERGED + FO-115/FO-115B Gantt refinement | FO-103–FO-114A on `main`; FO-115 + FO-115B on `feature/interactive-gantt-tenant-scope` (unmerged Draft PR #69); FO-102 deferred; FO-115A NOT STARTED |
