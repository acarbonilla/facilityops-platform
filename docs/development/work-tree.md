...
| Reporting and Operational Analytics | Complete + FO-088 AI insights | FO-064 through FO-067B complete; FO-088 adds `/reporting/ai-insights` under `reporting.view` |
