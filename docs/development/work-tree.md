...
| Reporting and Operational Analytics | In Progress | FO-064 + FO-064A + FO-065 complete on `feature/reporting` (draft PR #38); `/reporting` overview live with date/building/organization filters; status/priority UX (FO-066), export, and charts deferred |
